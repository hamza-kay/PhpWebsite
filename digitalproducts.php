            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/googlehome.jpg" alt="Google Home" height="152" width="152">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Google Home </h3>
                                    ...
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        ...
                                        <?php
                                            ...
                                            if(check_if_added_to_cart(18)){
                                                ...
                                                ?>
                                                <a href="add_to_cart.php?id=18" class="btn btn-block btn-primary" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                                                <?php
                                            }
                                        }
                                        ?>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/alexa.jpg" alt="Alexa" height="110" width="110">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Alexa</h3>
                                    ...
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        ...
                                        <?php
                                            ...
                                            if(check_if_added_to_cart(17)){
                                                ...
                                                ?>
                                                <a href="add_to_cart.php?id=17" class="btn btn-block btn-primary" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                                                <?php
                                            }
                                        }
                                        ?>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chrome.jpg" alt="Chrome" height="115" width="115">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Google Chrome</h3>
                                    ...
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        ...
                                        <?php
                                            ...
                                            if(check_if_added_to_cart(16)){
                                                ...
                                                ?>
                                                <a href="add_to_cart.php?id=16" class="btn btn-block btn-primary" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                                                <?php
                                            }
                                        }
                                        ?>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/kindle.jpg" alt="Kindle" height="105" width="105">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Kindle</h3>
                                    ...
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        ...
                                        <?php
                                            ...
                                            if(check_if_added_to_cart(19)){
                                                ...
                                                ?>
                                                <a href="add_to_cart.php?id=19" class="btn btn-block btn-primary " name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                                                <?php
                                            }
                                        }
                                        ?>
